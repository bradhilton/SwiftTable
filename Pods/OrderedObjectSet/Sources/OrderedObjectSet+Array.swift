...
extension OrderedObjectSet : ExpressibleByArrayLiteral, RangeReplaceableCollection {
    ...
    public mutating func replaceSubrange<C : Collection>(_ subRange: Range<Index>, with newElements: C) where C.Iterator.Element == IndexingIterator<OrderedObjectSet>.Element {
...
public func +=<Element, S : Sequence>(lhs: inout OrderedObjectSet<Element>, rhs: S) where S.Iterator.Element == Element {
