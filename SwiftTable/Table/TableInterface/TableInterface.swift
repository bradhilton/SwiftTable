...
public protocol TableInterface : _Table {
    ...
    func scrollToRow(_ row: Int, inSection section: SectionSource, atScrollPosition scrollPosition: UITableViewScrollPosition, animated: Bool)

    func insertSection(_ section: SectionSource, withRowAnimation animation: UITableViewRowAnimation)
    func deleteSection(_ section: SectionSource, withRowAnimation animation: UITableViewRowAnimation)
    func reloadSection(_ section: SectionSource, withRowAnimation animation: UITableViewRowAnimation)
    func insertRows(_ rows: [Int], inSection section: SectionSource, withRowAnimation animation: UITableViewRowAnimation)
    func deleteRows(_ rows: [Int], inSection section: SectionSource, withRowAnimation animation: UITableViewRowAnimation)
    func reloadRows(_ rows: [Int], inSection section: SectionSource, withRowAnimation animation: UITableViewRowAnimation)
    ...
    func selectRow(_ row: Int?, inSection section: SectionSource, animated: Bool, scrollPosition: UITableViewScrollPosition)
